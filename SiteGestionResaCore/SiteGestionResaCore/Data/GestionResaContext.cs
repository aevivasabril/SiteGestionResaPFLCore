    ...
    public partial class GestionResaContext : IdentityDbContext<utilisateur, IdentityRole<int>, int>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<equipement>().HasData(new equipement[] { new equipement { id = 162, nom = "Balance Arpège 150kg", zoneID = 6, numGmao = "BAL0002", mobile = false, type_activites = "2,4,5,6,8,9,10,11,13,14,15,16,17,18" }, new equipement { id = 163, nom = "Balance 32 Kg (KA32s)", zoneID = 9, numGmao = "BAL0003", mobile = false, type_activites = "2,3,4,5,6,8,9,10,11,13,14,15,16,17,18" }, 
                ...
                new equipement { id = 170, nom = "Mélangeur cuiseur Stephan", zoneID = 9, numGmao = "CUISMEL0001", mobile = false, type_activites = "13,14,15" }, new equipement { id = 171, nom = "Echangeur récupérateur", zoneID = 17, numGmao = "ECH0001", mobile = true, type_activites = "2,4,5,6,8,9,10,13,14,15,18" }, 
