...
namespace SiteGestionResaCore.Data.Data
{
    public partial class GestionResaContext : IdentityDbContext<utilisateur, IdentityRole<int>, int>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<equipement>().HasData(new equipement[] { new equipement { id = 162, nom = "Balance Arpège 150k", zoneID = 5, numGmao = "BAL0002", mobile = false, type_activites = "2,4,5,6,8,9,10,11,13,14,15,16,17,18" }, new equipement { id = 163, nom = "Balance 32 Kg (KA32s)", zoneID = 9, numGmao = "BAL0003", mobile = false, type_activites = "2,3,4,5,6,8,9,10,11,13,14,15,16,17,18" }, 
                new equipement { id = 164, nom = "Balance 300Kg (ID2 + KCS300)", zoneID = 3, numGmao = "BAL0004", mobile = false, type_activites = "2,4,5,6,8,9,10,11,13,14,15,16,17,18" }, new equipement { id = 165, nom = "Balance OHAUS 2 Kg (Scout Pro SPU2001)", zoneID = 16, numGmao = "BAL0011", mobile = true, type_activites = "2,3,4,5,6,8,9,10,11,13,14,15,16,17,18" }, 
                ...
                new equipement { id = 170, nom = "Mélangeur cuiseur stéphan", zoneID = 9, numGmao = "CUISMEL0001", mobile = false, type_activites = "13,14,15" }, new equipement { id = 171, nom = "Echangeur récupérateur", zoneID = 17, numGmao = "ECH0001", mobile = true, type_activites = "2,4,5,6,8,9,10,13,14,15,18" }, 
                ...
                new equipement { id = 202, nom = "Machine emballage sous vide BRITEK SC800L", zoneID = 15, numGmao = "EMB0001", mobile = true, type_activites = "13,14,15" }, new equipement { id = 203, nom = "Thermoscelleuse ERECAM semi-automatique dia:68/95/116", zoneID = 12, numGmao = "EMB0003", mobile = true, type_activites = "14,15" },
                ...
                new equipement { id = 247, nom = "Tablette Latitude 7212 Dell", zoneID = 17, numGmao = "", mobile = true, type_activites = "18" }, new equipement { id = 248, nom = "Thermomix TM5", zoneID = 12, numGmao = "BROY0029", mobile = true, type_activites = "9,13,14,15" },
                ...
                new equipement { id = 267, nom = "Thermomix TM6", zoneID = 16, numGmao = "BROY0046", mobile = true, type_activites = "9,13,14,15" }, new equipement {id = 268, nom = "Pilote UF forte concentration", zoneID = 8, numGmao = "PILOT0023", mobile = false, type_activites = "8"},
                new equipement { id = 269, nom = "Bain-marie sans couvercle", zoneID = 13, numGmao = "BTH0066", mobile = true, type_activites = "9"}, new equipement { id = 270, nom = "Bain-marie MEMMERT (avec couvercle, petite capacité)", zoneID = 16, numGmao = "BTH0065", mobile = true, type_activites = "9"},
                new equipement { id = 271, nom = "Bain-marie MEMMERT (avec couvercle, grande capacité)", zoneID = 15, numGmao = "BTH0033", mobile = true, type_activites = "9"}
            });
