    ...
    public partial class GestionResaContext : IdentityDbContext<utilisateur, IdentityRole<int>, int>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<equipement>().HasData(new equipement[] { new equipement { id = 162, nom = "Balance Arpège 150k", zoneID = 5, numGmao = "BAL0002", mobile = false }, new equipement { id = 163, nom = "Balance 32 Kg (KA32s)", zoneID = 9, numGmao = "BAL0003", mobile = false }, 
                ...
                new equipement { id = 182, nom = "Ecrémeuse Westfalia EASYCREAM", zoneID = 3, numGmao = "ECREM0002", mobile = false }, new equipement { id = 183, nom = "Mini-cuve N°1 (150L)", zoneID = 17, numGmao = "ECUV0003", mobile = true },
                ...
                new equipement { id = 188, nom = "2 cuves maturation 500L", zoneID = 3, numGmao = "ECUV0010", mobile = false }, new equipement { id = 189, nom = "Tank 1000L avec agitation et groupe froid", zoneID = 4, numGmao = "ECUV0012", mobile = false },
                ...
                new equipement { id = 200, nom = "Cuve 2000L avec agitateur", zoneID = 2, numGmao = "ECUV0026", mobile = false }, new equipement { id = 201, nom = "Mini-cuve N°5 (150L)", zoneID = 17, numGmao = "ECUV0027", mobile = true }, 
                ...
                new equipement { id = 210, nom = "Chariots porte-bassines PM (N°2)", zoneID = 6, numGmao = "MANUT0012", mobile = true }, new equipement { id = 211, nom = "Ensemble NEP", zoneID = 2, numGmao = "MLAV0016", mobile = false }, 
                new equipement { id = 212, nom = "Système de moulage PM et basculeur", zoneID = 5, numGmao = "MOUL0001", mobile = false }, new equipement { id = 213, nom = "Pilote ultrafiltration TIA spirale", zoneID = 8, numGmao = "PILOT0001", mobile = false }, 
                new equipement { id = 214, nom = "Pilote UF TIA/PALL 0,02u (JYG)", zoneID = 8, numGmao = "PILOT0002", mobile = false }, new equipement { id = 215, nom = "Pilote OI NF UF Prolab Milipore", zoneID = 8, numGmao = "PILOT0003", mobile = false }, 
                ...
                new equipement { id = 218, nom = "Pilote de microfiltration MFMG", zoneID = 3, numGmao = "PILOT0006", mobile = false }, new equipement { id = 219, nom = "Pilote de microfiltration MFS19", zoneID = 4, numGmao = "PILOT0007", mobile = false }, 
                new equipement { id = 220, nom = "Pilote de microfiltration GP7", zoneID = 4, numGmao = "PILOT0008", mobile = false }, new equipement { id = 221, nom = "UF TAMI/tech-sep 8 kDa (13 m2)", zoneID = 8, numGmao = "PILOT0009", mobile = false }, 
                new equipement { id = 222, nom = "Stérilisateur pilote tubulaire électrique ACTINI", zoneID = 3, numGmao = "PILOT0010", mobile = false }, new equipement { id = 223, nom = "Pilote de traitement thermique UHT-HTST Lab 25EDH", zoneID = 8, numGmao = "PILOT0011", mobile = false }, 
                new equipement { id = 224, nom = "Pilote UF TAMI/Tia 8Kda mobile", zoneID = 8, numGmao = "PILOT0013", mobile = true }, new equipement { id = 225, nom = "Pilote évaporateur à flot tombant FF-1", zoneID = 1, numGmao = "PILOT0014", mobile = false }, 
                ...
                new equipement { id = 228, nom = "Pilote tour de sèchage MINOR", zoneID = 1, numGmao = "PILOT0017", mobile = false }, new equipement { id = 229, nom = "Pilote VALOBAB (MF et UF) SKID 12EO46", zoneID = 3, numGmao = "PILOT0018", mobile = false }, 
                new equipement { id = 230, nom = "Pilote UF (optimal)", zoneID = 4, numGmao = "PILOT0019", mobile = false }, new equipement { id = 231, nom = "Pompe centrifuge 20 à 30 m3/h", zoneID = 17, numGmao = "POMPE0002", mobile = true }, 
