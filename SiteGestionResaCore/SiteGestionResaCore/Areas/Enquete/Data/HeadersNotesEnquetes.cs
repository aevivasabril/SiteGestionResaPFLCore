...
namespace SiteGestionResaCore.Areas.Enquete.Data.PostEnquete
{
    public class HeadersNotesEnquetes
    {
        ...
        public string MIQdeux = "I.2: Les procédures relatives aux modalités d'utilisation de la PFL, à l'utilisation des materiels, utilisation nettoyage étaient-elles claires?";
        ...
        public string MIIIQun = "III.1: L'état de proprète était-il satisfaisant?";
        public string MIIIQdeux = "III.2: La confidentialité de vos essais était-elle assurée?";
        public string MIIIQtrois = "III.3: Est-ce que votre environnement de travail était-il secure?";
        public string MIIIQquatre = "III.4: Le petit materiel de la zone de travail était-il disponible?";
        ...
        public string MIVQun = "IV.1: L'approvisionnement de matière première était-il satisfaisant?";
        ...
        public string MIVQtrois = "IV.3: L'approvisionnement des consommables(essuis main, surchaussures,...) était-il satisfaisant?";
